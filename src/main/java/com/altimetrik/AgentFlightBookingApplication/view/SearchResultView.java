 ...
 */
/**
 * This class display the search result of all possible trips between departure
...
public class SearchResultView {
	 ...
	 * 
	 * @param reservations
	 *            list of matched reservations including outbound and inbound if
	 *            any
	 * @param isRoundTrip
	 *            if it is a round-way trip
	 */
	 ...
	 * 
	 * @return return index of selected reservation, 0 if customer didn't select
	 *         any reservation
	 */
	public int setOutboundReservation() {
		...
		do {
			System.out.println(
					"***************Do you want to make OUTBOUND reservation right now?(yes/no)***************");
	...
	public int setInboundReservation() {
		...
		do {
			System.out.println(
					"***************Do you want to make INBOUND reservation right now?(yes/no)***************");
			input = scanner.nextLine();
	 ...
	 *            customer input
	 * @param results
	 *            reservations that need to be sorted
	 * 
	 */
