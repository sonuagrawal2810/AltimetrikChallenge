package com.altimetrik.AgentFlightBookingApplication.model.airplane;
...
public class Airplane {
	 ...
	 * 
	 * Verifies the model has a value Verifies there are more than 0 first class
	 * seats Verifies there are more than 0 coach seats
	 * 
