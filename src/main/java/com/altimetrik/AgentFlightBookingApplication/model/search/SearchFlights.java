...
import com.altimetrik.AgentFlightBookingApplication.model.reservation.Reservations;
...
/**
 * This class search both of one-way trip and round-way trip that satisfy
 * customer's requirement. Class member attributes are the same as defined by
 * the view.
 */
public class SearchFlights {
	 ...
	 * @param stopover
	 *            if customer wants stop overs between the origin and
	 *            destination
	 * @param round
	 *            if customer wants return flight
	 * 
	 */
	public SearchFlights(String depart, String arrival, String departureDate, String returnDate, String seat,
			boolean stopover, boolean round) {
	 ...
	 * 
	 * @param stop
	 *            if there is stop between the departure and arrival airport
	 */
	...
	/**
	 * This method will get the search result from SearchFlight class, it will
	 * check if customer wants return trip before search the return flights
	 * 
	 * @return list of reservations that contain matched flights, it may be
	 *         either one way trip or round way trip
	...
	public List<Reservations> getSearchResult() throws ParseException {
		...
		SearchFlight outbound = new SearchFlight(mDepartureAirportCode, mArrivalAirportCode, mDepartureDate,
				mSeatPreference, isStopOver);
		...
		if (isRoundTrip) {
			SearchFlight inbound = new SearchFlight(mArrivalAirportCode, mDepartureAirportCode, mReturnDate,
					mSeatPreference, isStopOver);
