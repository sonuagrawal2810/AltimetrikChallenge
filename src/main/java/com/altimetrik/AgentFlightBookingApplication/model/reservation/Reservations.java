...
public class Reservations extends ArrayList<Reservation> {
	 ...
	 * 
	 * @param reservations
	 *            all matched flights from departure airport to arrival airport
	 */
	...
	/**
	 * This method sort the reservations by total flight time from smallest to
	 * largest, layover time is also included
	 * 
	 * @param reservations
	 *            all matched flights from departure airport to arrival airport
	 */
	...
	/**
	 * This method sort the reservations by departure time from earliest to
	 * latest
	 * 
	 * @param reservations
	 *            all matched flights from departure airport to arrival airport
