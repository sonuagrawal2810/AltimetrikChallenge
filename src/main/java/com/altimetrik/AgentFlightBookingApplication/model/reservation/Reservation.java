package com.altimetrik.AgentFlightBookingApplication.model.reservation;
...
public class Reservation implements Comparable<Reservation> {
	 ...
	 *            a list of flights
	 * @param SeatType
	 *            a String "Coach" or "FirstClass" indicate which kind of seat
	 *            is preferred
	 * @param index
	 *            unique index for each reservation
	 */
	...
	public LocalDateTime getArrivalAirportTime() {
		...
		LocalDateTime arrivalTimeLocal = LocalDateTime.parse(legs.get(legs.size() - 1).getArrivalAirportTime(),
				dateFormat);
	 ...
	 * 
	 * @return string concludes detail flight information
	 */
	...
	/**
	 * Default comparator Compare two Reservation based on number of flights
	 * 
