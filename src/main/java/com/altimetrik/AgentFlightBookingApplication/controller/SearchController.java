package com.altimetrik.AgentFlightBookingApplication.controller;
...
import com.altimetrik.AgentFlightBookingApplication.model.search.SearchFlights;
import com.altimetrik.AgentFlightBookingApplication.view.InputView;
import com.altimetrik.AgentFlightBookingApplication.view.SearchResultView;
 ...
 */
/**
 * This class will take control of data flow. User will enter the search
 * information in view layer, controller will pass the input to model, and model
 * will connect server and search the result. The matched flights will be passed
 * to result displayer in view package.
 *
 */
public class SearchController {
	private InputView input; // user interface which will get all the search
								// information from user
	private SearchResultView searchResult; // user interface which will display
											// the search result to user
	private SearchFlights search; // new search

	/**
	 * Default constructor Constructor without parameters. Set user input, start
	 * a search, and allow making reservations.
	 * 
